  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <section className="relative gradient-hero text-white overflow-hidden pt-20 pb-6 md:pb-8">
          ...
          <div className="relative container-custom py-4 md:py-6 hero-inner">
            <div className="text-center max-w-4xl mx-auto">
              <h1 className="text-2xl md:text-3xl font-bold text-white drop-shadow-2xl mb-3">
        ...
        <section className="py-6 md:py-8">
          <div className="container-custom">
            <div className="card p-5 md:p-6 max-w-2xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/" className="btn-cta shadow-glow-yellow">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="relative gradient-hero text-white overflow-hidden pt-20 pb-6 md:pb-8">
        ...
        <div className="relative container-custom py-4 md:py-6 hero-inner">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white drop-shadow-2xl mb-3">
      ...
      {/* Features Section */}
      <section className="py-4 md:py-5 bg-white dark:bg-gray-800">
        <div className="container-custom">
          <div className="section-head">
            <div className="w-14 h-14 bg-gradient-to-br from-primary-500 to-teal-500 rounded-full flex items-center justify-center mx-auto mb-3">
              <Clock className="w-7 h-7 text-white" />
            </div>
            <h2 className="section-title text-2xl md:text-3xl text-gray-900 dark:text-white">Dashboard Coming Soon</h2>

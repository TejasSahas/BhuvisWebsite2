...
import DataConsultingPage from './pages/DataConsultingPage';
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">
            Real Estate Lead Automation &amp; Technology Enablement
          </p>
        </div>
      </div>
    );
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
          ...
          <main className="pt-20">
             <Routes>
               ...
               <Route path="/services/lead-automation" element={<LeadAutomationPage />} />
               ...
               <Route path="/market-intelligence" element={<Navigate to="/services/data-consulting" replace />} />
               <Route path="/products/brokerjodo" element={<BrokerJodoPage />} />

        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-primary-600 to-teal-600 rounded-xl flex items-center justify-center shadow-lg">
            ...
            <p className="text-gray-400 mb-4 max-w-md text-sm md:text-base leading-relaxed">
              Real estate lead automation and technology enablement. We help firms automate 
              lead generation, content creation, and sales processes using technology and data.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/services" className="text-gray-400 hover:text-white transition-all duration-300 hover:translate-x-1 flex items-center group">
                  <span className="group-hover:text-primary-400">Services</span>
                </Link>
              </li>
              <li>
                <Link to="/services/data-consulting" className="text-gray-400 hover:text-white transition-all duration-300 hover:translate-x-1 flex items-center group">
                  <span className="group-hover:text-primary-400">Data Consulting</span>
                </Link>
              </li>
              <li>
                <Link to="/products/brokerjodo" className="text-gray-400 hover:text-white transition-all duration-300 hover:translate-x-1 flex items-center group">
                  <span className="group-hover:text-primary-400">BrokerJodo</span>
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-400 hover:text-white transition-all duration-300 hover:translate-x-1 flex items-center group">
                  <span className="group-hover:text-primary-400">About Us</span>
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700/50 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            <div className="text-sm text-gray-400">
              © {currentYear} BhuvisX - Real Estate Lead Automation &amp; Technology Enablement. All rights reserved.
            </div>

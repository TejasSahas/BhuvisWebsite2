...
// API key loaded from environment variables (optional for local dev)
const PERPLEXITY_API_KEY = process.env.PERPLEXITY_API_KEY;

if (!PERPLEXITY_API_KEY) {
  console.warn('⚠️ PERPLEXITY_API_KEY is not set — Bhuvis AI chat will be disabled. Add it to .env to enable.');
}

...
// MongoDB connection (optional for local dev without DB)
const mongoose = require('mongoose');
const mongoUri = process.env.MONGO_URI || config.db.url;
const hasValidMongoUri = mongoUri && (mongoUri.startsWith('mongodb://') || mongoUri.startsWith('mongodb+srv://'));
...
if (hasValidMongoUri) {
  ...
  console.warn('⚠️ MONGO_URI not set — auth and bookings will be disabled. Add MONGO_URI to .env for full features.');
}
